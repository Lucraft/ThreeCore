...
import com.threetag.threecore.base.client.renderer.entity.SquirrelRenderer;
...
public class ThreeCoreBase {
    ...
    // Entities
    @ObjectHolder("squirrel")
    public static EntityType<SquirrelEntity> SQUIRREL;
    ...
    public void registerEntities(RegistryEvent.Register<EntityType<?>> e) {
        e.getRegistry().register(EntityType.Builder.create(SquirrelEntity::new, EntityClassification.CREATURE).size(0.4F, 0.4F).build("squirrel").setRegistryName(ThreeCore.MODID, "squirrel"));
    }
